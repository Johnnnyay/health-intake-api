...
const SCRUB_PROMPT = 'You edit a health report written in English for clients who do not read Chinese. '
  ...
  + 'sentence, and replace Chinese punctuation with English punctuation. Rephrase around the term so the '
  + 'sentence reads as if it had been written in English: "the 清肠毒 pair" becomes "the gut-clearing pair", '
  + 'not "the clearing the gut pair". Where a term only repeats what the sentence already says in English, '
  + 'drop it. Change nothing else: keep the '
