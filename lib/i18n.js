...
const CHROME = {
  en: {
    ...
    ctaPasscode: 'For member pricing: tap ··· in the top right and enter the passcode your consultant gave you', ctaLockedBtn: 'Locked', ctaLockedSub: 'Your consultant will unlock your product list when you go through the report together.', iboLabel: 'Partner', iboUnlocked: 'Unlocked ✓', iboPrompt: 'Partner passcode', iboWrong: 'Incorrect passcode', iboLockQ: 'Lock the product list again?', iboFail: 'Could not update the report. Check the connection and try again.',
  ...
  zh: {
    ...
    ctaPasscode: '会员价格：点击右上角 ··· 输入顾问给你的通行码', ctaLockedBtn: '暂未开放', ctaLockedSub: '和顾问一起看报告时，顾问会为你开放产品清单。', iboLabel: '合伙人', iboUnlocked: '已开放 ✓', iboPrompt: '请输入合伙人密码', iboWrong: '密码不正确', iboLockQ: '要重新锁定产品清单吗？', iboFail: '暂时无法更新报告，请检查网络后重试。',
  ...
  es: {
    ...
    ctaPasscode: 'Para precio de miembro: toca ··· arriba a la derecha e introduce el código que te dio tu consultor', ctaLockedBtn: 'Bloqueado', ctaLockedSub: 'Tu consultor desbloqueará tu lista de productos cuando revisen el informe juntos.', iboLabel: 'Socio', iboUnlocked: 'Desbloqueado ✓', iboPrompt: 'Código de socio', iboWrong: 'Código incorrecto', iboLockQ: '¿Bloquear la lista de productos de nuevo?', iboFail: 'No se pudo actualizar el informe. Revisa la conexión e inténtalo de nuevo.',
  ...
  hi: {
    ...
    ctaPasscode: 'सदस्य मूल्य के लिए: ऊपर दाईं ओर ··· दबाएँ और सलाहकार का दिया पासकोड डालें', ctaLockedBtn: 'लॉक है', ctaLockedSub: 'जब आप अपने सलाहकार के साथ रिपोर्ट देखेंगे, तब वे आपकी उत्पाद सूची खोल देंगे।', iboLabel: 'पार्टनर', iboUnlocked: 'खुला है ✓', iboPrompt: 'पार्टनर पासकोड', iboWrong: 'गलत पासकोड', iboLockQ: 'उत्पाद सूची फिर से लॉक करें?', iboFail: 'रिपोर्ट अपडेट नहीं हो सकी। कनेक्शन जाँचकर फिर कोशिश करें।',
