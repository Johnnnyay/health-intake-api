...
const CHROME = {
  en: {
    ...
    expect: 'What To Expect', expectSub: 'What the first month usually feels like, and what is worth watching for.',
    ...
    refCard: 'How much is enough, and why it matters',
    refCardSub: 'Most people who conclude supplements did nothing for them were taking an amount that was never going to do anything. There are four different numbers a label or a plan can mean by enough, and only one of them is about fixing something you can feel. These are the four, smallest to largest.',
    ...
    ctaPasscode: 'For member pricing: tap ··· in the top right and enter the passcode your consultant gave you', ctaLockedBtn: 'Locked', ctaLockedSub: 'Your consultant will unlock your product list when you go through the report together.', gateTitle: 'Your report is ready', gateBody: 'Thank you for completing your assessment. Your health assessment consultant will unlock your report and take you through it in person. If you are with them now, ask them to unlock it, then tap Check again.', gateCheck: 'Check again', gateChecking: 'Checking…', gateStill: 'Still locked. Ask your consultant to unlock it.', iboOpen: 'Admin login', iboCodeLabel: 'Admin passcode', iboSignIn: 'Sign in', iboCancel: 'Cancel', iboWrong: 'Incorrect passcode', iboFail: 'Could not update the report. Check the connection and try again.', iboBar: 'Admin view', iboReport: 'Report', iboProducts: 'Product list', stLocked: 'Locked', stOpen: 'Unlocked', iboSignOut: 'Sign out', iboHint: 'Clients do not see this bar.', iboLabel: 'Admin', iboAll: 'All reports', prioTitle: 'What you asked us to focus on',
  ...
  zh: {
    ...
    expect: '预期变化', expectSub: '第一个月大致是什么节奏，以及值得留意的地方。',
    ...
    refCard: '吃多少才够，以及为什么这件事重要',
    refCardSub: '很多人觉得补充剂对自己没用，其实是吃的那个量本来就不可能有用。够这个字，背后有四个完全不同的数字，而其中只有一个是奔着把问题解决掉、让你感觉得到去的。下面四个，从小到大。',
    ...
    ctaPasscode: '会员价格：点击右上角 ··· 输入顾问给你的通行码', ctaLockedBtn: '暂未开放', ctaLockedSub: '和顾问一起看报告时，顾问会为你开放产品清单。', gateTitle: '你的报告已经准备好了', gateBody: '感谢你完成健康评估。你的健康评估顾问会为你解锁报告，并当面为你详细解读。如果你现在就和顾问在一起，请让顾问帮你解锁，然后点击“再次查看”。', gateCheck: '再次查看', gateChecking: '正在查看…', gateStill: '仍未解锁，请让顾问为你解锁。', iboOpen: '管理员登录', iboCodeLabel: '管理员密码', iboSignIn: '登录', iboCancel: '取消', iboWrong: '密码不正确', iboFail: '暂时无法更新报告，请检查网络后重试。', iboBar: '管理员视图', iboReport: '报告', iboProducts: '产品清单', stLocked: '已锁定', stOpen: '已开放', iboSignOut: '退出登录', iboHint: '客户看不到这一栏。', iboLabel: '管理员', iboAll: '全部报告', prioTitle: '你希望我们重点关注的方面',
  ...
  es: {
    ...
    expect: 'Qué esperar', expectSub: 'Cómo suele sentirse el primer mes y qué vale la pena observar.',
    ...
    refCard: 'Cuanto es suficiente, y por que importa',
    refCardSub: 'La mayoria de quienes concluyen que los suplementos no les hicieron nada tomaban una cantidad que nunca iba a hacer nada. Hay cuatro numeros distintos que una etiqueta o un plan puede querer decir con suficiente, y solo uno trata de arreglar algo que usted note. Estos son los cuatro, de menor a mayor.',
    ...
    ctaPasscode: 'Para precio de miembro: toca ··· arriba a la derecha e introduce el código que te dio tu consultor', ctaLockedBtn: 'Bloqueado', ctaLockedSub: 'Tu consultor desbloqueará tu lista de productos cuando revisen el informe juntos.', gateTitle: 'Su informe está listo', gateBody: 'Gracias por completar su evaluación. Su consultor de evaluación de salud desbloqueará su informe y lo revisará con usted en persona. Si está con él ahora, pídale que lo desbloquee y luego toque Comprobar de nuevo.', gateCheck: 'Comprobar de nuevo', gateChecking: 'Comprobando…', gateStill: 'Sigue bloqueado. Pide a tu consultor que lo desbloquee.', iboOpen: 'Acceso de administrador', iboCodeLabel: 'Código de administrador', iboSignIn: 'Entrar', iboCancel: 'Cancelar', iboWrong: 'Código incorrecto', iboFail: 'No se pudo actualizar el informe. Revisa la conexión e inténtalo de nuevo.', iboBar: 'Vista de administrador', iboReport: 'Informe', iboProducts: 'Lista de productos', stLocked: 'Bloqueado', stOpen: 'Desbloqueado', iboSignOut: 'Salir', iboHint: 'Los clientes no ven esta barra.', iboLabel: 'Administrador', iboAll: 'Todos los informes', prioTitle: 'En qué nos pidió centrarnos',
  ...
  hi: {
    ...
    expect: 'क्या अपेक्षा करें', expectSub: 'पहला महीना आम तौर पर कैसा रहता है, और किन बातों पर ध्यान देना है।',
    ...
    refCard: 'कितना पर्याप्त है, और यह क्यों मायने रखता है',
    refCardSub: 'जो लोग कहते हैं कि अनुपूरकों से उन्हें कुछ नहीं हुआ, वे अक्सर ऐसी मात्रा ले रहे थे जिससे कुछ होना ही नहीं था। पर्याप्त के चार अलग-अलग अर्थ हैं, और उनमें से केवल एक उस चीज़ को ठीक करने के बारे में है जो आपको महसूस हो। ये रहे चारों, छोटे से बड़े क्रम में।',
    ...
    ctaPasscode: 'सदस्य मूल्य के लिए: ऊपर दाईं ओर ··· दबाएँ और सलाहकार का दिया पासकोड डालें', ctaLockedBtn: 'लॉक है', ctaLockedSub: 'जब आप अपने सलाहकार के साथ रिपोर्ट देखेंगे, तब वे आपकी उत्पाद सूची खोल देंगे।', gateTitle: 'आपकी रिपोर्ट तैयार है', gateBody: 'मूल्यांकन पूरा करने के लिए धन्यवाद। आपके स्वास्थ्य मूल्यांकन सलाहकार आपकी रिपोर्ट खोलेंगे और आपके साथ बैठकर उसे समझाएँगे। अगर आप अभी उनके साथ हैं, तो उनसे इसे खोलने को कहें, फिर फिर से जाँचें दबाएँ।', gateCheck: 'फिर से जाँचें', gateChecking: 'जाँच रहे हैं…', gateStill: 'अभी भी लॉक है। अपने सलाहकार से इसे खोलने को कहें।', iboOpen: 'एडमिन लॉगिन', iboCodeLabel: 'एडमिन पासकोड', iboSignIn: 'साइन इन', iboCancel: 'रद्द करें', iboWrong: 'गलत पासकोड', iboFail: 'रिपोर्ट अपडेट नहीं हो सकी। कनेक्शन जाँचकर फिर कोशिश करें।', iboBar: 'एडमिन दृश्य', iboReport: 'रिपोर्ट', iboProducts: 'उत्पाद सूची', stLocked: 'लॉक है', stOpen: 'खुला है', iboSignOut: 'साइन आउट', iboHint: 'ग्राहकों को यह पट्टी नहीं दिखती।', iboLabel: 'एडमिन', iboAll: 'सभी रिपोर्ट', prioTitle: 'आपने हमसे किन बातों पर ध्यान देने को कहा',
...
const SHAPE = {
  /* tierNote, optionA, optionB and wins are no longer produced. They stay listed so
     reports written before the four-section template still translate. */
  ...
  objects: {
    ...
    expectations: { fields: ['headline', 'finding', 'change', 'when'] },
    /* Field names may be dotted. Everything the client reads inside the "How to take
       it" disclosure lives under dosing, and leaving it out of here is why a Chinese
       report used to show its dose text in English. */
    products:     { fields: ['rationale', 'note', 'dosing.howMuch', 'dosing.why',
                             'dosing.food', 'dosing.tolerability'],
                    objectLists: { 'dosing.nutrients': ['name'] } }
  }
};
...
function collect(a) {
  const out = [];
  /* A record whose generation failed stores analysis: null. Throwing here turns that
     into a 500 on the language switch instead of the "preparing" page. */
  ...
  Object.entries(SHAPE.objects).forEach(([key, def]) => {
    (a[key] || []).forEach((obj, i) => {
      (def.fields || []).forEach(f => add(`${key}.${i}.${f}`, getPath(obj, f)));
      (def.lists || []).forEach(l => (getPath(obj, l) || []).forEach((v, j) => add(`${key}.${i}.${l}.${j}`, v)));
      Object.entries(def.objectLists || {}).forEach(([l, fields]) => {
        (getPath(obj, l) || []).forEach((o, j) => fields.forEach(f => add(`${key}.${i}.${l}.${j}.${f}`, o && o[f])));
      });
    });
  });
  return out;
...
/* Chinese characters and Chinese/full-width punctuation. The spec is written from Chinese
   teaching material, and the model has leaked its terms into English prose ("the 清肠毒 pair").
   Only a Chinese page may carry them. */
const CJK_RE = /[　-〿㐀-䶿一-鿿豈-﫿！-｠]/;
function hasCjk(s) { return CJK_RE.test(String(s || '')); }

/* Prose leaves of the English analysis that contain Chinese. Stage keys and ids are not
   prose (collect() skips them), so a legacy 清 stage key is not flagged. */
function cjkLeaves(a) { return collect(a).filter(it => hasCjk(it.text)); }

/* Which leaves this locale is still missing. Generic: no per-language field list.
   Pass the locale so a non-Chinese overlay line that carries Chinese counts as missing. */
function missing(a, overlay, locale) {
  const ov = overlay || {};
  return collect(a).filter(it => {
    const v = getPath(ov, it.path);
    if (v === null || v === undefined || !String(v).trim()) return true;
    if (locale && locale !== 'zh' && hasCjk(v) && !hasCjk(it.text)) return true;
    /* U+FFFD is a character lost in decoding (a reply read chunk by chunk split a multi-byte
       character; fixed 2026-09-24). A line carrying one is damaged, so translate it again. */
    return String(v).includes('�') && !String(it.text).includes('�');
  });
}

function isComplete(a, overlay, locale) {
  return missing(a, overlay, locale).length === 0;
}
...
function systemPrompt(locale) {
  ...
  return `You translate a personalised health report from English into ${cfg.language} for a client in a wellness consulting practice.\n\n`
    ...
    /* [[UL]] and friends are markers the renderer turns into a definition bubble. A
       translator that renders them as words, or drops the brackets, silently removes
       the definition from that language and no error is raised. */
    + '- Text in double square brackets is a marker, not words. Copy [[UL]], [[RDA]], [[AI]], [[EAR]], [[DV]], [[%DV]] and [[PI]] through EXACTLY as they appear, brackets included, in the same place in the sentence. Do not translate them, expand them, or remove the brackets.\n'
    + '- Never add a claim, a promise, or a timeframe that is not in the source.\n'
    /* A bare " inside a translated value ends the JSON string early, and the whole batch fails
       to parse. Seen twice on one report (dosing lines quoting a food name). */
    + '- Never put a straight double quote (") inside a translated value. For quotation marks use 「」 in Chinese or “” in other languages.\n'
    + '- Return ONLY a JSON object mapping each id to its translated string. No markdown, no commentary.';
}


/* Reference-intake vocabulary, explained the way a client needs it rather than the
   way a textbook does. The renderer turns [[UL]] in any prose into the term with a
   bubble, so the skill only has to mark the word. Every entry links to the source. */
const GLOSSARY = {
  EAR: {
    en: ['EAR: Estimated Average Requirement', 'The amount that covers half the people in a group. Half still fall short at this level, so it is a research figure rather than a personal target.'],
    zh: ['EAR：平均需要量', '能满足人群中一半人的量。也就是说另一半人在这个量上仍然不够，所以它是研究用的数字，不是个人目标。'],
    es: ['EAR: Requerimiento Promedio Estimado', 'La cantidad que cubre a la mitad de un grupo. La otra mitad se queda corta, así que es una cifra de investigación, no un objetivo personal.'],
    hi: ['EAR: अनुमानित औसत आवश्यकता', 'वह मात्रा जो समूह के आधे लोगों के लिए पर्याप्त है। यह शोध का आँकड़ा है, व्यक्तिगत लक्ष्य नहीं।']
  },
  RDA: {
    en: ['RDA: Recommended Dietary Allowance', 'Enough to stop a deficiency disease in almost everybody. This is the floor, not the goal. It keeps you from getting ill; it does not repair or heal anything. A multivitamin taken daily is aimed here, and for someone with nothing wrong that is exactly right.'],
    zh: ['RDA / RNI：推荐摄入量', '足以让绝大多数人不出现缺乏症的量。这是底线，不是目标。它保证你不生病，但不修复、不改善任何东西。每天一份复合维生素瞄准的就是这个位置，对一个本来没什么问题的人来说，这样刚刚好。'],
    es: ['RDA: Cantidad Diaria Recomendada', 'Suficiente para evitar una enfermedad por carencia en casi todos. Es el suelo, no la meta. Evita que enferme; no repara ni cura nada. Un multivitaminico diario apunta aqui, y para alguien sin ningun problema eso es exactamente lo correcto.'],
    hi: ['RDA: अनुशंसित आहार भत्ता', 'लगभग सभी में कमी-जनित रोग रोकने के लिए पर्याप्त। यह न्यूनतम है, लक्ष्य नहीं। यह आपको बीमार होने से बचाता है; यह कुछ ठीक या मरम्मत नहीं करता। रोज़ का मल्टीविटामिन यहीं निशाना लगाता है।']
  },
  AI: {
    en: ['AI: Adequate Intake', 'Above the RDA, and the first amount that can actually change something. It is not a fixed published number: it is what your own habits, symptoms and body weight call for, so it has to be worked out for you rather than looked up. It also moves. As your habits change and symptoms settle, your AI changes with them, which is why this gets re-estimated at each check-in rather than set once.'],
    zh: ['AI：适宜摄入量', '高于推荐摄入量，是第一个真正可能改变些什么的量。它不是一个公布好的固定数字，而是你自己的生活习惯、症状和体重共同决定的，所以只能算出来，查不到。它还会动：习惯变了、症状缓解了，你的适宜摄入量也跟着变，所以这个数字每次复查都要重新估，而不是定一次就完事。'],
    es: ['AI: Ingesta Adecuada', 'Por encima de la RDA, y la primera cantidad que de verdad puede cambiar algo. No es una cifra fija publicada: es lo que piden sus propios habitos, sintomas y peso, asi que se calcula para usted en lugar de consultarse. Ademas se mueve, por eso se vuelve a estimar en cada revision.'],
    hi: ['AI: पर्याप्त सेवन', 'RDA से ऊपर, और पहली ऐसी मात्रा जो वास्तव में कुछ बदल सकती है। यह कोई तय प्रकाशित संख्या नहीं है: यह आपकी अपनी आदतों, लक्षणों और वज़न से तय होती है, इसलिए इसे खोजा नहीं, निकाला जाता है। यह बदलती भी रहती है।']
  },
  UL: {
    en: ['UL: Tolerable Upper Intake Level', 'The most you can take every day, long term, without expecting a problem. It is a ceiling, and this plan never goes above it. Where a symptom is something you get often, the amount is set close to here on purpose, because that is where a change becomes noticeable. It is not meant to stay there: once the symptom eases, the amount comes back down toward your AI and stays there.'],
    zh: ['UL：可耐受最高摄入量', '长期每天可以摄入而不出问题的上限。这是天花板，本方案绝不越过它。如果某个症状你是"经常"出现，用量会有意贴近这里，因为要到这个位置变化才感觉得到。但它不是让你长期停在这儿：症状缓解之后，用量要回落到你的适宜摄入量，然后长期维持在那里。'],
    es: ['UL: Nivel Maximo Tolerable', 'Lo maximo que puede tomar a diario a largo plazo sin esperar problemas. Es un techo y este plan nunca lo supera. Cuando un sintoma es frecuente, la cantidad se fija a proposito cerca de aqui, porque ahi es donde el cambio se nota. No es para quedarse: al ceder el sintoma, la cantidad baja hacia su AI.'],
    hi: ['UL: सहनीय ऊपरी सीमा', 'लंबे समय तक रोज़ लेने की अधिकतम सीमा। यह छत है और यह योजना इसे कभी पार नहीं करती। जब कोई लक्षण अक्सर होता है, मात्रा जानबूझकर इसके पास रखी जाती है, क्योंकि बदलाव वहीं महसूस होता है। लक्षण घटने पर मात्रा आपके AI की ओर लौट आती है।']
  },
  DV: {
    en: ['%DV: Percent Daily Value', 'The number printed on the bottle. The FDA sets it as one single figure for the whole population, so it is not calculated for you, your symptoms or your weight, and it is not a safety limit either. It is a labelling convention. It is the one number here you should NOT be comparing yourself against, and it is the only one most people ever see.'],
    zh: ['%DV：每日营养素参考值百分比', '瓶子上印的那个数。FDA 为全体人群设的一个统一数字，不是按你的情况、症状或体重算出来的，也不是安全上限，它只是标签规范。这里四个数字里，它恰恰是你最不该拿来对照自己的那个，却又是绝大多数人唯一见过的那个。'],
    es: ['%DV: Porcentaje de Valor Diario', 'El numero impreso en el frasco. La FDA lo fija como una sola cifra para toda la poblacion, asi que no esta calculado para usted, sus sintomas ni su peso, y tampoco es un limite de seguridad. Es una convencion de etiquetado. Es el unico numero aqui con el que NO deberia compararse, y es el unico que la mayoria llega a ver.'],
    hi: ['%DV: दैनिक मूल्य प्रतिशत', 'बोतल पर छपा नंबर। FDA इसे पूरी आबादी के लिए एक ही आंकड़े के रूप में तय करता है, यह आपके लिए, आपके लक्षणों या वज़न के लिए गणना नहीं किया गया, और न ही यह सुरक्षा सीमा है। यह लेबलिंग की परंपरा है। यहाँ यही एक नंबर है जिससे आपको अपनी तुलना नहीं करनी चाहिए।']
  },
  PI: {
    en: ['PI: Proposed Intake for chronic disease prevention', 'A Chinese reference value with no US equivalent: how much to take to lower long-term disease risk, rather than merely to avoid a deficiency. It sits between the RDA and the UL.'],
    zh: ['PI：预防非传染性慢性病的建议摄入量', '中国 2013 版新增的量，美国没有对应类别：为降低长期患病风险该吃多少，而不只是不缺乏。它落在推荐摄入量之上、上限之下。'],
    es: ['PI: Ingesta Propuesta para prevención de enfermedad crónica', 'Un valor de referencia chino sin equivalente en EE. UU. Está entre la RDA y el UL.'],
    hi: ['PI: दीर्घकालिक रोग रोकथाम हेतु प्रस्तावित सेवन', 'चीनी संदर्भ मान, जिसका अमेरिकी समकक्ष नहीं है। यह RDA और UL के बीच है।']
  }
};
const GLOSSARY_LINK = {
  EAR: 'https://ods.od.nih.gov/HealthInformation/nutrientrecommendations.aspx',
  RDA: 'https://ods.od.nih.gov/HealthInformation/nutrientrecommendations.aspx',
  AI:  'https://ods.od.nih.gov/HealthInformation/nutrientrecommendations.aspx',
  UL:  'https://ods.od.nih.gov/HealthInformation/nutrientrecommendations.aspx',
  DV:  'https://www.fda.gov/food/nutrition-facts-label/daily-value-nutrition-and-supplement-facts-labels',
  PI:  'https://www.chinanutri.cn/xxzy/xxzydybgsj/201506/t20150603_115510.html'
};

module.exports = {
  CANONICAL, LOCALES, CHROME, LOCALE_NAME, LOCALE_SHORT, STAGES, GLOSSARY, GLOSSARY_LINK, STAGE_KEYS, stageKey,
  SHAPE, collect, getPath, setPath, missing, isComplete, resolve, hasCjk, cjkLeaves,
