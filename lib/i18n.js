...
const CHROME = {
  en: {
    ...
    ctaPasscode: 'For member pricing: tap ··· in the top right and enter the passcode your consultant gave you', ctaLockedBtn: 'Locked', ctaLockedSub: 'Your consultant will unlock your product list when you go through the report together.', gateTitle: 'Your report is ready', gateBody: 'Thank you for completing your assessment. Your consultant will unlock your report when you go through it together. Ask them to unlock it now, then tap Check again.', gateCheck: 'Check again', gateChecking: 'Checking…', gateStill: 'Still locked. Ask your consultant to unlock it.', iboOpen: 'Admin login', iboCodeLabel: 'Admin passcode', iboSignIn: 'Sign in', iboCancel: 'Cancel', iboWrong: 'Incorrect passcode', iboFail: 'Could not update the report. Check the connection and try again.', iboBar: 'Admin view', iboReport: 'Report', iboProducts: 'Product list', stLocked: 'Locked', stOpen: 'Unlocked', iboSignOut: 'Sign out', iboHint: 'Clients do not see this bar.', iboLabel: 'Admin', iboAll: 'All reports',
  ...
  zh: {
    ...
    ctaPasscode: '会员价格：点击右上角 ··· 输入顾问给你的通行码', ctaLockedBtn: '暂未开放', ctaLockedSub: '和顾问一起看报告时，顾问会为你开放产品清单。', gateTitle: '你的报告已经准备好了', gateBody: '感谢你完成健康评估。顾问会在和你一起解读时为你解锁报告。请现在让顾问帮你解锁，然后点击“再次查看”。', gateCheck: '再次查看', gateChecking: '正在查看…', gateStill: '仍未解锁，请让顾问为你解锁。', iboOpen: '管理员登录', iboCodeLabel: '管理员密码', iboSignIn: '登录', iboCancel: '取消', iboWrong: '密码不正确', iboFail: '暂时无法更新报告，请检查网络后重试。', iboBar: '管理员视图', iboReport: '报告', iboProducts: '产品清单', stLocked: '已锁定', stOpen: '已开放', iboSignOut: '退出登录', iboHint: '客户看不到这一栏。', iboLabel: '管理员', iboAll: '全部报告',
