...
const CHROME = {
  en: {
    ...
    refCard: 'Reference intakes, in plain language',
    refCardSub: 'The numbers this report measures your doses against. Each links to the body that publishes it.',
  ...
  zh: {
    ...
    refCard: '参考摄入量,说人话版',
    refCardSub: '本报告用来衡量你用量的那几个数字。每一条都链接到发布它的机构。',
  ...
  es: {
    ...
    refCard: 'Ingestas de referencia, en lenguaje sencillo',
    refCardSub: 'Las cifras contra las que este informe mide sus dosis. Cada una enlaza al organismo que la publica.',
  ...
  hi: {
    ...
    refCard: 'संदर्भ मात्राएँ, सरल भाषा में',
    refCardSub: 'वे संख्याएँ जिनके सापेक्ष यह रिपोर्ट आपकी खुराक मापती है। हर एक प्रकाशक संस्था से जुड़ी है।',
...
const GLOSSARY = {
  ...
  RDA: {
    en: ['RDA: Recommended Dietary Allowance', 'Enough to stop a deficiency in almost everyone. It is the floor, not the goal: it prevents you getting ill, it does not repair anything.'],
    zh: ['RDA / RNI：推荐摄入量', '足以让绝大多数人不出现缺乏症的量。这是底线不是目标：它保证你不生病，但不修复任何东西。'],
    es: ['RDA: Cantidad Diaria Recomendada', 'Suficiente para evitar una carencia en casi todos. Es el suelo, no la meta: evita que enferme, no repara nada.'],
    hi: ['RDA: अनुशंसित आहार भत्ता', 'लगभग सभी में कमी रोकने के लिए पर्याप्त। यह न्यूनतम है, लक्ष्य नहीं।']
  },
  AI: {
    en: ['AI: Adequate Intake', 'What your own habits, symptoms and body weight actually call for. It is individual, so it is calculated rather than looked up, and it sits above the RDA.'],
    zh: ['AI：适宜摄入量', '你自己的生活习惯、症状和体重真正需要的量。因人而异，所以是算出来的而不是查出来的，它高于推荐摄入量。'],
    es: ['AI: Ingesta Adecuada', 'Lo que piden sus propios hábitos, síntomas y peso. Es individual, así que se calcula, y está por encima de la RDA.'],
    hi: ['AI: पर्याप्त सेवन', 'आपकी अपनी आदतें, लक्षण और वज़न जितना माँगते हैं। यह व्यक्तिगत है और RDA से ऊपर है।']
  },
  UL: {
    en: ['UL: Tolerable Upper Intake Level', 'The most you can take every day, long term, without expecting a problem. This plan never goes above it. Some ULs mark real toxicity, others only mark discomfort, and the report says which.'],
    zh: ['UL：可耐受最高摄入量', '长期每天可以摄入而不出问题的上限。本方案绝不超过它。有些 UL 标记的是真正的毒性，有些只是不适感，报告会写明是哪一种。'],
    es: ['UL: Nivel Máximo Tolerable', 'Lo máximo que puede tomar a diario a largo plazo sin esperar problemas. Este plan nunca lo supera.'],
    hi: ['UL: सहनीय ऊपरी सीमा', 'लंबे समय तक रोज़ लेने की अधिकतम सीमा। यह योजना इसे कभी पार नहीं करती।']
  },
  DV: {
    en: ['%DV: Percent Daily Value', 'A labelling figure set by the FDA for the general public. It is NOT a safety limit: 556% of the Daily Value can still be a quarter of the Upper Limit.'],
    zh: ['%DV：每日营养素参考值百分比', '这是 FDA 为一般人群设的标示数字，**不是安全上限**。556% 的 DV 仍然可能只占 UL 的四分之一。'],
    es: ['%DV: Porcentaje de Valor Diario', 'Una cifra de etiquetado de la FDA. NO es un límite de seguridad: 556% del Valor Diario puede seguir siendo un cuarto del Límite Superior.'],
    hi: ['%DV: दैनिक मूल्य प्रतिशत', 'FDA का लेबलिंग आँकड़ा। यह सुरक्षा सीमा नहीं है।']
  },
  PI: {
