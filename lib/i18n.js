...
const CHROME = {
  ...
  zh: {
    ...
    ctaPasscode: '会员价格：点击右上角 ··· 输入顾问给你的通行码', ctaLockedBtn: '暂未开放', ctaLockedSub: '和顾问一起看报告时，顾问会为你开放产品清单。', gateTitle: '你的报告已经准备好了', gateBody: '感谢你完成健康评估。顾问会在和你一起解读时为你解锁报告。请现在让顾问帮你解锁，然后点击“再次查看”。', gateCheck: '再次查看', gateChecking: '正在查看…', gateStill: '仍未解锁，请让顾问为你解锁。', iboOpen: '合伙人登录', iboCodeLabel: '合伙人密码', iboSignIn: '登录', iboCancel: '取消', iboWrong: '密码不正确', iboFail: '暂时无法更新报告，请检查网络后重试。', iboBar: '合伙人视图', iboReport: '报告', iboProducts: '产品清单', stLocked: '已锁定', stOpen: '已开放', iboSignOut: '退出登录', iboHint: '客户看不到这一栏。', iboLabel: '合伙人',
