...
const L = {
  en: { heroLabel:'Personalized Health Analysis', consultant:'Consultant', recheck:'Recheck in 4 Weeks',
        ...
        mYounger:(n)=>`${n} years younger than actual`, mMatch:'Matches actual age', mOlder:(n)=>`${n} years older than actual`,
  ...
  zh: { heroLabel:'个人健康分析', consultant:'顾问', recheck:'四周后复查',
        ...
        mYounger:(n)=>`比实际年龄小 ${n} 岁`, mMatch:'与实际年龄相同', mOlder:(n)=>`比实际年龄大 ${n} 岁`,
