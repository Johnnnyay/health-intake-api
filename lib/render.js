...
<style>
  ...
  *{box-sizing:border-box;margin:0;padding:0}
  ...
  .dose-detail summary::before{content:"▸ ";font-weight:800;display:inline-block;transition:transform .15s}
  ...
  .term-q{display:inline-grid;place-items:center;width:17px;height:17px;border-radius:50%;
    background:var(--gray-100);color:var(--gray-500);font-size:11px;font-weight:700;
    margin-left:5px;vertical-align:-3px;line-height:1;transition:background .15s,color .15s}
